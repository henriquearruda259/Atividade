...
public class Gerente extends Funcionario {
    ...
    protected String setores;
    protected  double comissaoTotalGerente;

    public Gerente(int idade, String nome, String cpf, String cargo, double salario, double comissaoGerente, String setor, double comissaoTotalGerente, String setores) {
